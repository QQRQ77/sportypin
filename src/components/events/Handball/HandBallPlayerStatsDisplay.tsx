...
const HandBallPlayerStatsDisplay: React.FC<HandBallPlayerStatsDisplayProps> = ({
  ...
  return (
    <div className='w-14 flex flex-col items-center justify-start'>
      <div className='w-full h-10 flex flex-2 items-center gap-1'>{goals > 0 && <><div className='w-8 flex justify-center items-center border'><PiSoccerBallLight size={24} /></div><div className='w-6 text-green-700 font-bold border'>{goals}</div></>}</div>
